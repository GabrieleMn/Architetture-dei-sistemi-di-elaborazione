...
;mat2			DCD		-2,3
				...
				;DCD		4,3
				;DCD		9,-7
mat1			DCD		0x00000BB8, 0x000036B0, 0xFFFFC568, 0x00002328, 0x00006590, 0xFFFF30F8, 0x00001388
...
mat2			DCD		0x00009088, 0xFFFE7578, 0x0,		0x0000E290, 0xFFFFB1E0
...
prossimaRiga	add r0,#4*M
				ldr r1,[sp,#15*4]	;mat2
				eor r11,r11
				eor r12,r12
				add r10,#1	;contatore righe
				b loop3
				
controllo		cmp r6,#0xFFFFFFFF
				beq	checkF
				cmp r6,#0x00000000
				beq	check0
...
checkF			and r7,r5,#0x80000000
				lsr r7,#31
				cmp r7,#1
				bne overflowNEG
				b salva
				
check0			and r7,r5,#0x80000000
				cmp r7,#0
				bne overflowPOS
				b salva
				
overflowPOS		mov r5,#0x7fffffff
				b salva

overflowNEG		mov r5,#0x80000000
				b salva
