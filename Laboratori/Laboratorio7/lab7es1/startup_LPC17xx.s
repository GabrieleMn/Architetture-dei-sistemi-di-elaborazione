...
fillStack		PROC
				...
				LDR R5,[SP,#24]		; R5 <-- pointer stack
				LDR R6,[SP,#28]		; R6 <-- pointer memoria variabili
				EOR R4,R4
...
control			CMP R7,#0		; controllo se sono alla prima iterazione
				BNE nextStack0	; se NON sono alla prima iterazione e ho preso 0 cambio stack
				ADD R7,#1		; altrimenti scarto lo 0 e non lo inserisco
				B fillLoop
								
nextStack		SUB R6,#4		; se cambio stack perchè valore successivo maggiore devo tornare indietro 
nextStack0		STR R5,[SP,#24]	
				STR R6,[SP,#28]
